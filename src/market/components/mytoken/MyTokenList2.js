...
import MyModal from './EditMyPainting'
        ...
        },
        {
                ...
                render: (text, record) => (
                  <span>
					 ...
					 <MyModal open={ modalOpen } close={ closeModal } {...props} header="Modal heading"/>
                  </span>
                ),
              }
         ];
